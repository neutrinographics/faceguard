...
pub const YOLO_MODEL_URL: &str =
    "https://github.com/neutrinographics/video-blur/releases/download/v0.1.0/yolo11n-pose_widerface.onnx";

pub const EMBEDDING_MODEL_NAME: &str = "w600k_r50.onnx";
pub const EMBEDDING_MODEL_URL: &str =
    "https://github.com/neutrinographics/video-blur/releases/download/v0.1.0/w600k_r50.onnx";
